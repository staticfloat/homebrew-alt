...
class Julia < Formula
  ...
  head 'https://github.com/JuliaLang/julia.git', :branch => "local_blas"
  ...
  depends_on "homebrew/dupes/openblas"
  ...
  def install
    ...
    #ln_s "#{Formula.factory('lapack').lib}/liblapack.dylib", "lib/"
